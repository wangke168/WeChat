...
<head>
	...
	//                window.editor = K.create('#editor_id');
			...
			'link', 'unlink', '|', 'image', 'flash','insertVideo','media']
		});
				prettyPrint();
			});
		</script>
	...
	/*		  if (document.myform.content1.value=="")
			  {
				alert("文章内容不能为空！");
							...
							<div class="form-horizontal portlet-body form">
								...
								<div class="control-group">
									...
									?>
										...
										<?php
											...
											$result = mysql_query("select * from WX_menu_list where online='1' and parents_id='0' order by id asc");
												...
												while ($row_option = mysql_fetch_array($result_option))
												 {
													...
													echo "<option value=\"".$row_option["ID"]."\">".$row_option["Menu_name"]."</option>";
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										...
										<input type="text"  class="m-wrap large" name="title" />
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										...
										<input id="keyword" name="keyword" type="text"  class="m-wrap large" />
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text"  class="m-wrap large"  id="url1" name="url1" value="" />
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text"  class="m-wrap large"  id="url3" name="url3" value="" />
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<input type="text"  class="m-wrap large" name="pyq_title" />
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										...
										<textarea name="content1" style="width:400px;height:200px;visibility:hidden;"></textarea> 
										</textarea>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										...
										<input type="text" name="url"  class="m-wrap large" />
								...
								<div class="control-group">
									...
									<div class="controls">
                                        ...
                                        <input type="checkbox"  name="Show_Qr" id="Show_Qr" value="yes" checked />
								...
								<div class="control-group">
									...
									<div class="controls">
                                        ...
                                        <input type="checkbox"  name="allow_copy" id="allow_copy" value="yes" />
                                ...
                                <div class="control-group">
									...
									<div class="controls">
                                        ...
                                        <input id="Modal2in" name="marketid" type="text" class="m-wrap large" value="全部" />
									...
									<div class="modal-body">
										...
										<?php
											...
											while($row = mysql_fetch_array($result))
											{
												...
												echo "<input name=\"keyword1\" type=\"checkbox\">".$row["Keyword"];
