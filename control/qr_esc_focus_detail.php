                                                ...
                                                <div>
												   ...
												   <?php
													...
													<table class="table table-bordered table-hover">
														...
														<?php
...

															{
																...
																echo "<td>".GetMarketFocus($row['Qrscene_id'],date("Y/m/d"),$x)."</td>";
																echo "<td>".GetEscFocus($row['Qrscene_id'],date("Y/m/d"),$x)."</td>";
													...
													<?php
														...
														if($page>1)
														{
															echo "<li><a href='qr_esc_list_detail.php?date=".$date."&x=".$x."&page=".$first."&Qrscene_id=".$qr_id."&keyword=".$keyword."'>首页</a></li>";
															echo "<li><a href='qr_esc_list_detail.php?date=".$date."&x=".$x."&page=".$prev."&Qrscene_id=".$qr_id."&keyword=".$keyword."'>上一页</a></li>";
														}

										//                echo " 共有" .$pages. "页(" .$page. "/" .$pages.")";
														for($i=1; $i<$page; $i++)
															echo "<li><a href='qr_esc_list_detail.php?date=".$date."&x=".$x."&page=".$i."&Qrscene_id=".$qr_id."&keyword=".$keyword."'>".$i."</a></li>";
														echo "<li class='active'><a href='#'>" .$page. "</a></li>";
														for($i=$page+1; $i<=$pages;$i++)
															echo "<li><a href='qr_esc_list_detail.php?date=".$date."&x=".$x."&page=".$i."&Qrscene_id=".$qr_id."&keyword=".$keyword."'>".$i."</a></li>";
														if($page<$pages)
														{
															echo "<li><a href='qr_esc_list_detail.php?date=".$date."&x=".$x."&page=".$next."&Qrscene_id=".$qr_id."&keyword=".$keyword."'>下一页</a></li>";
															echo "<li><a href='qr_esc_list_detail.php?date=".$date."&x=".$x."&page=".$last."&Qrscene_id=".$qr_id."&keyword=".$keyword."'>最后一页</a></li>";
														}
														echo "</ul>";
														echo"</div>";
													?>
