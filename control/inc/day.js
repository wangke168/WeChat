...
/*  http://2lin.net  Email:caoailin@gmail.com **/
function Calendar(objName)  
{		
this.style = {
borderColor       		: "#7C8C8C",  //边框颜色
headerBackColor    		: "#3C3C3C",  //表头背景颜色
headerFontColor    		: "#ffffff",  //表头字体颜色
bodyBarBackColor  		: "#F1F1EE",  //日历标题背景色
bodyBarFontColor  		: "#EE0033",  //日历标题字体色
bodyBackColor     		: "#ffffff",  //日历背景色
bodyFontColor           : "#000000",  //日历字体色 
bodyHolidayFontColor    : "#880033",  //假日字体色
...
str += '<div Author="alin" class="cdrWatermark" id="cdrWatermark"></div><div id="cdrBody" style="position:absolute;left:0px;top:0px;z-index:2;width:168px;">';
str += this.getHeader();
str += this.getBody();   
...
str += '.calendar{position:absolute;width:168px!important;width /**/:152px;height:188px!important;height /**/:174px;background-color:'+this.style.bodyBackColor+';border:1px solid ' + this.style.borderColor + ';left:0px;top:0px;z-index:9999;}\n';
str += '.cdrHeader{background-color:'+ this.style.headerBackColor +';width:168px;height:24px;font-size:13px;color:'+this.style.headerFontColor+';}\n';
str += '.cdrBodyBar{background-color:' + this.style.bodyBarBackColor + ';color:' + this.style.bodyBarFontColor + ';width:168px;height:21px;}\n';
str += '.cdrBody{width:168px;height:122px!important; height /**/:110px;cursor:pointer;color:' + this.style.bodyFontColor + ';}\n';
str += '.dayOver{height:16px;padding:0px;border:1px solid #688;color:#000;background-color:#ffffe0;}\n';
str += '.dayOut{padding:1px;border:none;height:16px;}\n';
str += '.menuOver{background-color:'+this.style.headerBackColor+';color:'+this.style.headerFontColor+';}\n';
str += '.headerOver{background-color:#EE0033;cursor:default;}\n';
str += '.cdrMenu{border:1px solid #000000;background-color:#ffffff;cursor:default;width:100%}\n';
...
str += '</table>\n';
str += '<table Author="alin" class="cdrBodyBar" cellSpacing="2" cellPadding="0"><tr align="center" Author="alin"><td Author="alin" style="cursor:pointer;" onclick="'+this.Obj+'.getToday();" style="color:#6c7c7c;font-size:10px;">Today Date: '+new Date().toFormatString("yyyy-mm-dd")+'</td></tr></table>\n';
return str;
};
...
str += '<tr Author="alin" align="center"><td Author="alin"><table Author="alin" style="width:100%;" cellSpacing="0" cellPadding="0">\n';
