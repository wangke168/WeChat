...
class JSSDK {
    ...
    public function getSignPackage() {
        ...
        $url = "http://weix2.hengdianworld.com$_SERVER[REQUEST_URI]";
        $timestamp = time();
    ...
    private function getJsApiTicket() {
        ...
        if (!$ticket)
        {
            $url="http://weix2.hengdianworld.com/server/wechat/inc/gettoken.php";
            $accessToken=file_get_contents($url);//这个地方不能用file_get_contents
