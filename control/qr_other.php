							...
							<div class="portlet-body">
                                ...
                                <div class="btn-group">
                                                    ...
                                                    <div class="input-append">
                                                        ...
                                                        <form method="GET" name="myform"  action="qr_other.php">
												   ...
												   <?php
                                                       ...
                                                       $query="SELECT count(*) FROM WX_Qrscene_Info WHERE classid='4' and qrscene_name like '%".$keyword."%' ";
													...
													<table class="table table-bordered table-hover">
														...
														<?php
															...
															$url="SELECT * FROM WX_Qrscene_Info WHERE ClassID='4' and qrscene_name like '%".$keyword."%' order by id asc limit ".$offset.",".$pagesize;
													...
													<?php
														...
														if($page>1)
														{
															echo "<li><a href='qr_other.php?page=".$first."&Qrscene_id=".$qr_id."&keyword=".$keyword."'>首页</a></li>";
															echo "<li><a href='qr_other.php?page=".$prev."&Qrscene_id=".$qr_id."&keyword=".$keyword."'>上一页</a></li>";
														}

										//                echo " 共有" .$pages. "页(" .$page. "/" .$pages.")";
														for($i=1; $i<$page; $i++)
															echo "<li><a href='qr_other.php?page=".$i."&Qrscene_id=".$qr_id."&keyword=".$keyword."'>".$i."</a></li>";
														echo "<li class='active'><a href='#'>" .$page. "</a></li>";
														for($i=$page+1; $i<=$pages;$i++)
															echo "<li><a href='qr_other.php?page=".$i."&Qrscene_id=".$qr_id."&keyword=".$keyword."'>".$i."</a></li>";
														if($page<$pages)
														{
															echo "<li><a href='qr_other.php?page=".$next."&Qrscene_id=".$qr_id."&keyword=".$keyword."'>下一页</a></li>";
															echo "<li><a href='qr_other.php?page=".$last."&Qrscene_id=".$qr_id."&keyword=".$keyword."'>最后一页</a></li>";
														}
														echo "</ul>";
														echo"</div>";
													?>
