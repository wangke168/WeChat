	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			if ($classid!="")
				...
				{
                //    echo $user_eventket;
					$query="SELECT count(*) FROM wx_article where eventkey <> 'all'  and title like '%".$keyword."%'";
				}
 ...
 //           $query="SELECT count(*) FROM wx_article where eventkey like '%".$user_eventket."%' and title like '%".$keyword."%' and  classid like '%".$classid."%'";
            ...
            ?>
               ...
               <?php
				...
				{
					$query1="SELECT * FROM wx_article where eventkey <> 'all'  and title like '%".$keyword."%'   order by  id desc limit ".$offset.",".$pagesize;
				}
	...
	//				echo "<a href='ArticleCopy.php?id=".$row['id']."'>复制</a>&nbsp;&nbsp;";
                    echo "<a href='../article/Articledetail.php?id=".$row['id']."'>查看</a>&nbsp;&nbsp;";
...
<?php
                ...
                if($page>1)
                {
                    echo "<li><a href='ArticleList_market.php?classid=".$classid."&page=".$first."&keyword=".$keyword."'>首页</a></li>";
                    echo "<li><a href='ArticleList_market.php?classid=".$classid."&page=".$prev."&keyword=".$keyword."'>上一页</a></li>";
                }

//                echo " 共有" .$pages. "页(" .$page. "/" .$pages.")";
                for($i=1; $i<$page; $i++)
                    echo "<li><a href='ArticleList_market.php?classid=".$classid."&page=".$i."&keyword=".$keyword."'>".$i."</a></li>";
                echo "<li class='active'><a href='#'>" .$page. "</a></li>";
                for($i=$page+1; $i<=$pages;$i++)
                    echo "<li><a href='ArticleList_market.php?classid=".$classid."&page=".$i."&keyword=".$keyword."'>".$i."</a></li>";
                if($page<$pages)
                {
                    echo "<li><a href='ArticleList_market.php?classid=".$classid."&page=".$next."&keyword=".$keyword."'>下一页</a></li>";
                    echo "<li><a href='ArticleList_market.php?classid=".$classid."&page=".$last."&keyword=".$keyword."'>最后一页</a></li>";
                }
				echo "</ul>";
                echo"</div>";
                ?>
