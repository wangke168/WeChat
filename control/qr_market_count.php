						...
						<div class="portlet box purple">
							...
							<div class="portlet-body">
													...
													<table class="table table-bordered table-hover">
                                                        ...
                                                        {
                                                            echo "<tr>";
                                                            echo "<td>".GetMonth($x)."</td>";
                                                            echo "<td>".Market_info($qr_id)."</td>";
                                                            echo "<td>".GetMarketFocus($qr_id,date("Y/m/d"),$x)."</td>";
                                                            echo "<td>".GetEscFocus($qr_id,date("Y/m/d"),$x)."</td>";
                                                            echo "<td>".(GetMarketFocus($qr_id,date("Y/m/d"),$x)-GetEscFocus($qr_id,date("Y/m/d"),$x))."</td>";
                                                            echo "</tr>";
                                                            ...
                                                            /*
                                                                ...
                                                                echo "<td><a href='qr_esc_list_detail.php?date=".GetMonth(date("Y/m/d"),$x)."&x=".$x."'>".GetMonth(date("Y/m/d"),$x)."</a></td>";
                                                        ...
                                                        <!--
										                    ...
										                    <tr>
											                    ...
											                    <td>
                                                                    <?php echo Market_info($qr_id);?>
											                    </td>

											                    <td>
                                                                    <?php echo GetMarketFocus($qr_id,'2015-11-1');?>
											                    </td>

                                                                <td>
                                                                     <?php echo GetEscFocus($qr_id,'2015-11-1');?>
                                                                </td>

																 <td>
                                                                   <?php echo (GetMarketFocus($qr_id,'2015-11-1')-GetEscFocus($qr_id,'2015-11-1'));?>
											                    </td>
