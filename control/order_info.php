...
*/
        ...
        <table class="table table-bordered table-hover">
            ...
            $result = mysql_query("SELECT * FROM wx_order_send  order by id DESC limit " . $offset . "," . $pagesize . "", $link);
            while ($row = mysql_fetch_array($result)) {

                $query = "SELECT * FROM wx_order_confirm WHERE SellID='".$row["SellID"]."'";
...
//                echo $query;
        ...
        if ($page > 1) {
            echo "<li><a href='order_info.php?page=" . $first . "'>首页</a></li>";
            echo "<li><a href='order_info.php?page=" . $prev . "'>上一页</a></li>";
        }

        //                echo " 共有" .$pages. "页(" .$page. "/" .$pages.")";
        for ($i = 1; $i < $page; $i++)
            echo "<li><a href='order_info.php?page=" . $i . "'>" . $i . "</a></li>";
        echo "<li class='active'><a href='#'>" . $page . "</a></li>";
        for ($i = $page + 1; $i <= $pages; $i++)
            echo "<li><a href='order_info.php?page=" . $i . "'>" . $i . "</a></li>";
        if ($page < $pages) {
            echo "<li><a href='order_info.php?page=" . $next . "'>下一页</a></li>";
            echo "<li><a href='order_info.php?page=" . $last . "'>最后一页</a></li>";
        }
        echo "</ul>";
        echo "</div>";
        ?>
