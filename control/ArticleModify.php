...
<head>
	...
	//                window.editor = K.create('#editor_id');
			...
			'link', 'unlink', '|', 'image','media','flash','insertVideo']
		});
				prettyPrint();
			});
		</script>
            ...
            <div class="container-fluid">
				...
				<div class="row-fluid">
                    ...
                    <div class="span12">
						...
						<form method="POST" name="myform" onSubmit="return CheckForm();" action="ArticleSave.php?action=modify" target="_self">
							...
							<div class="form-horizontal portlet-body form">
											...
											while($row = mysql_fetch_array($result))
											 {
												...
												while ($row_option = mysql_fetch_array($result_option))
												 {
													if ($classid==$row_option["ID"])
													 {

													echo "<option selected  value=\"".$row_option["ID"]."\">".$row_option["Menu_name"]."</option>";
													 }
													else
													 {
                                ...
                                <div class="control-group">
									...
									<div class="controls">
                                        ...
                                        <input id="Modal2in" name="marketid" type="text"   value="<?php echo Market_info($eventkey_market); ?>"  />
